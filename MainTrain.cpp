...
int main() //Train
{
	...
	if (3 != bank.GetNumberOfAccounts())
		cout << "Error in updating number of account in the bank1(-4)" << endl;
	...
	if (3 != bank.GetNumberOfAccounts())
		cout << "Error in updating number of account in the bank2(-4)" << endl;

	bank.AddAccount(Account(liam, 9955));
	if (4 != bank.GetNumberOfAccounts())
		cout << "Error in updating number of account in the bank3(-4)" << endl;

	bank.AddAccount(account);
	if (4 != bank.GetNumberOfAccounts())
		cout << "Error in updating number of account in the bank4(-4)" << endl;

	bank.DeletePerson(liam);
	if (3 != bank.GetNumberOfAccounts())
		cout << "Error in updating number of account in the bank5(-4)" << endl;
